...
<head>
    ...
    <title>Privacy Policy for Igniters Lab</title>
    ...
    <style>
        * {
        ...
        body {
            width: auto;
            height: auto;
            background-image: linear-gradient(#d3d3d3, #fcdbb1);
            text-align: justify;
        }
...
<body>
    <header>
        <nav>
            <div class="header">
                <a href="https://igniterslab.com">
                    <img class="logo" src="/assets/images/logoIcon/logo.png" alt="IgnitersLab">
                </a>
            </div>
        </nav>
    </header>
    <main>
        <div class="section">
            <h1>Privacy Policy for Igniters Lab</h1>
            <p>
                At Igniters Lab, accessible from https://igniterslab.com/, one of our
                main priorities is the privacy of our visitors. This Privacy Policy
                document contains types of information that is collected and recorded by
                Igniters Lab and how we use it.
            </p>
            <p>
            ...
            <p>
                ...
                shared and/or collect in Igniters Lab. This policy is not applicable to
        ...
        <div class="section">
            <h1>Log Files</h1>
            <p>
                Igniters Lab follows a standard procedure of using log files. These
        ...
        <div class="section">
            ...
            <p>
                Like any other website, Igniters Lab uses "cookies". These cookies are
        ...
        <div class="section">
            ...
            <p>
                ...
                advertising partners of Igniters Lab.
            </p>
            <p>
                Third-party ad servers or ad networks uses technologies like cookies,
                JavaScript, or Web Beacons that are used in their respective
                advertisements and links that appear on Igniters Lab, which are sent
            ...
            <p>
                Note that Igniters Lab has no access to or control over these cookies
        ...
        <div class="section">
            ...
            <p>
                Igniters Lab's Privacy Policy does not apply to other advertisers or
        ...
        <div class="section">
            ...
            <p>
                Igniters Lab does not knowingly collect any Personal Identifiable
        ...
        <div class="section">
            ...
            <p>
                ...
                not hesitate to contact us at contact@igniterslab.com
            </p>
        </div>
    </main>
    <footer>
