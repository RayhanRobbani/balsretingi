                            ...
                            <form action="{{ route('user.withdraw.money') }}" method="post">
                                ...
                                <div class="mt-3 preview-details d-none">
                                    <ul class="list-group text-center">
                                        ...
                                        <li class="list-group-item d-flex justify-content-between">
                                            <div>
                                                <span>Minimum <strong>1</strong> non-freemium refer in last 30 days</span>
                                            </div>
                                            <div>
                                                @if ($isAllowed)
                                ...
                                <button type="submit" class="btn btn--base w-100 mt-3" @if (!$isAllowed) disabled @endif >@lang('Submit')</button>
                            </form>
                        </div>
                    </div>
                </div>
