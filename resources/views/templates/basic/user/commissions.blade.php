                                ...
                                <div class="d-flex flex-wrap gap-4">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <select class="form-select form--select" name="level">
                                            <option value="">@lang('Any')</option>
                                            @for ($i = 1; $i <= $levels; $i++)
                                                <option value="{{ $i }}">{{ __(ordinal($i)) }} @lang('Level')
                                                </option>
                                            @endfor
                                        </select>
                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td data-label="@lang('Commission Type')">
                                                    @if ($log->type == 'deposit_commission')
                                                        <span class="text-success">@lang('Deposit')</span>
                                                    @elseif($log->type == 'plan_subscribe_commission')
                                                        <span class="text-dark">@lang('Plan Subscribe')</span>
                                                    @else
                                                        <span class="text-primary">@lang('Ads View')</span>
                                                    @endif
                                                </td>
                                                <td data-label="@lang('Amount')">{{ showAmount($log->amount) }}
