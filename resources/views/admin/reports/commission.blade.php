                        ...
                        <table class="table table--light style--two" id="myTable">
                            ...
                            <tbody>
                                @forelse($commissions as $data)
                                    <tr>
                                        <td data-label="@lang('Date')">{{ showDateTime($data->created_at, 'Y-m-d') }}
                                        </td>
                                        <td data-label="@lang('User')">
                                            <span class="fw-bold">{{ $data->userTo->fullname }}</span>
                                            <br>
                                            <span class="small"> <a
                                                    href="{{ route('admin.users.detail', $data->userTo->id) }}"><span>@</span>{{ $data->userTo->username }}</a>
                                            </span>
                                        </td>
                                        ...
                                        <td data-label="@lang('Amount')">
                                            <span
                                                class="fw-bold">{{ __($general->cur_sym) }}{{ getAmount($data->amount) }}</span>
                                        </td>
