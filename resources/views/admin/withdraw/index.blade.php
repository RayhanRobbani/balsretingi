                            ...
                            <tbody>
                                @forelse($methods as $method)
                                    <tr>
                                        ...
                                        <td data-label="@lang('Charge')" class="fw-bold">
                                        ...
                                        <td data-label="@lang('Action')" class="d-flex justify-content-end">
                                            ...
                                            <form action="{{ route('admin.withdraw.method.delete', $method->id) }}"
...
@push('breadcrumb-plugins')
    <div class="d-flex flex-wrap justify-content-end">
        <a class="btn btn-outline--primary h-45 me-2 mb-2" href="{{ route('admin.withdraw.method.create') }}"><i
