                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td data-label="@lang('Action')" class="d-flex justify-content-end">
                                <button class="btn btn-outline--primary btn-sm planBtn me-2" data-id="{{ $plan->id }}" data-name="{{ $plan->name }}" data-price="{{ getAmount($plan->price) }}" data-daily_limit="{{ $plan->daily_limit }}" data-validity="{{ $plan->validity }}" data-status="{{ $plan->status }}" data-ref_level="{{ $plan->ref_level}}" data-act="Edit">
            ...
            <form action="{{ route('admin.plan.save') }}" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="earn" placeholder="@lang('Earn')" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="hierarchy_level" placeholder="@lang('Position in Subscription Hierarchy')" min="0" required>
                    </div>
                    <div class="form-group">
