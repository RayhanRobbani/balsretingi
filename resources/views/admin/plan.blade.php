                        ...
                        <table class="table table--light style--two">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">@lang('Hierarchy Level')</th>
                                    <th scope="col">@lang('Price')</th>
                                    <th scope="col">@lang('Earn')</th>
                                    <th scope="col">@lang('Limit/Day')</th>
                                    <th scope="col">@lang('Base Point Multiplier')</th>
                            ...
                            <tbody>
                                @forelse($plans as $plan)
                                    <tr>
                                        ...
                                        <td data-label="@lang('Hierarchy Level')">{{ $plan->hierarchy_level }}</td>
                                        <td data-label="@lang('Price')" class="font-weight-bold">
                                            {{ showAmount($plan->price) }} {{ $general->cur_text }}</td>
                                        <td data-label="@lang('Name')">{{ $plan->earn }}</td>

                                        <td data-label="@lang('Limit/Day')">{{ $plan->daily_limit }} @lang('PTC')</td>
                                        <td data-label="@lang('Base Point Multiplier')">{{ $plan->base_multiplier }}</td>
                                        <td data-label="@lang('Validity')">{{ $plan->validity }} @lang('Day')</td>
                                        <td data-label="@lang('Referral Commission')">@lang('up to') <span
                                        ...
                                        <td data-label="@lang('Action')" class="d-flex justify-content-end">
                                            <button class="btn btn-outline--primary btn-sm planBtn me-2"
                                                ...
                                                data-ref_level="{{ $plan->ref_level }}" data-earn="{{ $plan->earn }}"
                                                data-hierarchy_level="{{ $plan->hierarchy_level }}"
                                                data-base_multiplier="{{ $plan->base_multiplier }}" data-act="Edit">
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('admin.plan.save') }}" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="name">@lang('Earn') </label>
                            <input type="text" class="form-control" name="earn" placeholder="@lang('Earn')"
                                required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="hierarchy_level">@lang('Position in Subscription Hierarchy')</label>
                            <input type="number" class="form-control" name="hierarchy_level"
                                placeholder="@lang('Position in Subscription Hierarchy')" min="0" required>
                        </div>
                        <div class="form-group">
                            <label for="base_multiplier">@lang('Base Point Multiplier')</label>
                            <input type="number" class="form-control" name="base_multiplier"
                                placeholder="@lang('Base Point Multiplier')" min="0" step=".01" required>
                        </div>
                        <div class="form-group">
    ...
    <script>
        (function($) {
            ...
            $('.planBtn').on('click', function() {
                ...
                modal.find('input[name=earn]').val($(this).data('earn'));
                ...
                modal.find('input[name=hierarchy_level]').val($(this).data('hierarchy_level'));
                modal.find('input[name=base_multiplier]').val($(this).data('base_multiplier'));
                if ($(this).data('id') == 0) {
