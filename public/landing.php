...
<head>
    ...
    <!-- swiper carousel css -->
    <link rel="stylesheet" href="../new/assets/vendor/swiperjs-6.6.2/swiper-bundle.min.css">

    <!-- style css for this template -->
    <link href="../new/assets/css/style.css" rel="stylesheet" id="style">
</head>
...
<body class="body-scroll d-flex flex-column h-100" data-page="landing">
    ...
    <main class="container-fluid h-100">
        <a href="/user/login" class="skipbtn">Skip</a>
                ...
                <div class="swiper-slide">
                    <div class="row h-100">
                        <div class="col-11 col-md-8 col-lg-6 col-xl-4 mx-auto align-self-center text-center">
                            <div class="row">
                                <div class="col-ld-6">
                                    <img src="../new/assets/img/intro1.png" alt="" class="mw-100 mx-auto mb-5">
                                </div>
                                <div class="col-ld-6">
                ...
                <div class="swiper-slide">
                    <div class="row h-100">
                        <div class="col-11 col-md-8 col-lg-6 col-xl-4 mx-auto align-self-center text-center">
                            <div class="row">
                                <div class="col-ld-6">
                                    <img src="../new/assets/img/intro2.png" alt="" class="mw-100 mx-auto mb-5">
                                </div>
                                <div class="col-ld-6">
                ...
                <div class="swiper-slide">
                    <div class="row h-100">
                        <div class="col-11 col-md-8 col-lg-6 col-xl-4 mx-auto align-self-center text-center">
                            <div class="row">
                                <div class="col-ld-6">
                                    <img src="../new/assets/img/intro3.png" alt="" class="mw-100 mx-auto mb-5">
                                </div>
                                <div class="col-ld-6">
    ...
    <!--            <img src="new/assets/img/favicon32.png" class="rounded me-2" alt="...">-->
    ...
    <script src="../new/assets/vendor/bootstrap-5/js/bootstrap.bundle.min.js"></script>

    <!-- cookie js -->
    <script src="../new/assets/js/jquery.cookie.js"></script>

    <!-- Customized jquery file  -->
    <script src="../new/assets/js/main.js"></script>
    <script src="../new/assets/js/color-scheme.js"></script>

    <!-- PWA app service registration and works -->
    <script src="../new/assets/js/pwa-services.js"></script>

    <!-- swiper js script -->
    <script src="../new/assets/vendor/swiperjs-6.6.2/swiper-bundle.min.js"></script>
