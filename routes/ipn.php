...
Route::post('mercado-pago', 'MercadoPago\ProcessController@ipn')->name('MercadoPago');
 Route::post('uddoktapay','uddoktapay\ProcessController@ipn')->name('uddoktapay');
    Route::post('uddoktapay/webhook','uddoktapay\ProcessController@webhook')->name('uddoktapay.webhook');
